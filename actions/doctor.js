...
export async function getDoctorAppointments() {
  const { userId } = await auth();
  console.log("DEBUG: getDoctorAppointments - Clerk User ID:", userId); // Log Clerk User ID
  ...
  try {
    ...
    console.log("DEBUG: getDoctorAppointments - Querying for doctor with clerkUserId:", userId, "and role: DOCTOR");
    ...
    console.log("DEBUG: getDoctorAppointments - Doctor from DB:", JSON.stringify(doctor, null, 2)); // Log doctor object

    if (!doctor) {
      // Log if doctor is not found with the specific query
      console.error("DEBUG: getDoctorAppointments - Doctor not found with clerkUserId:", userId, "and role: DOCTOR");
      throw new Error("Doctor not found");
    }
    ...
    // Ensure the original error message is included if it's not "Doctor not found"
    if (error.message === "Doctor not found") {
        throw error; // Re-throw the specific "Doctor not found" error
    }
